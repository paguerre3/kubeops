...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/1-pod-communication-ip.PNG" width="23%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/2-pod-communication-svc.PNG" width="48%" height="30%"> 
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/3-pod-communication-ingress.PNG" width="48%" height="30%">
...
**NOTE**
> The case of exposing Dockerfile/entrypoint/env variables accessible in docker-compose doesn't require image rebuild of the compose after changes but it works in a lower level of abstraction i.e docker-runtime and it needs restart, e.g. docker-compose -f {docker-compose.yml} down/up, e.g. [Dockerfile](https://github.com/paguerre3/dockerops/blob/master/Dockerfile) + [docker-compose](https://github.com/paguerre3/dockerops/blob/master/complete.yml)
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/4-pod-communication-cm-secret.PNG" width="43%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/5-pod-communication-volumes.PNG" width="23%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/6-pod-communication-svc-deployment.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/7-pod-communication-svc-statefulset.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/8-k8s-cluster-processes.PNG" width="43%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/9-master-processes.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/10-minikube.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/11-kubectl-commands-1.PNG" width="48%" height="30%">
<img src="https://github.com/paguerre3/kubeops/blob/master/support/11-kubectl-commands-2.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/12-status-change-of-replicas.PNG" width="48%" height="30%">  
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/13-connecting-deployment-service.PNG" width="68%" height="60%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/14-ports-in-service-and-pods.png" width="73%" height="70%">
...
- e.g. [nginx Deployment](https://github.com/paguerre3/kubeops/blob/master/nginx-deployment.yml) + [nginx Service](https://github.com/paguerre3/kubeops/blob/master/nginx-service.yml) execution <code>kubectl apply -f .\nginx-deployment.yml</code> + <code>kubectl apply -f .\nginx-service.yml</code>
...
- 4=create ConfigMap for storing mongodb address to be used by "mongoexpress" Deployment for communicating with mongodb. Note that ConfigMap is used as a centralized store for common configurations among Deployments/Pods because the Deployment itself can hold the URL value directly but its a less preferred option than ConfigMap as if other Deployments/Pods need to use the same address it won't be shared. Warning, if ConfigMap reference is used inside a Deployment then ConfigMap must be created in 1st place! e.g. [mongo ConfigMap](https://github.com/paguerre3/kubeops/blob/master/mongo-configmap.yml) and execution <pre><code>kubectl apply -f .\mongo-configmap.yml
configmap/mongodb-configmap created</code></pre>
- 5=create "mongoexpress" Deployment for communicating with mongodb, using ConfigMap as reference, and also create "External"Service inside same yamel so mongoexpress ui can be accessed from browser, e.g. [mongoexpress Deployment + ExternalService](https://github.com/paguerre3/kubeops/blob/master/mongoexpress.yml) and execution <pre><code>kubectl apply -f .\mongoexpress.yml
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/16-minikube-assign-external-ip.PNG" width="48%" height="30%">
...
- another way of creating namespaces is using a configuration file, e.g. [my\-namespace](https://github.com/paguerre3/kubeops/blob/master/namespace.yml) and execution <pre><code>kubectl apply -f .\namespace.yml
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/17-namespace-in-configfile.PNG" width="28%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/18-each-namespace-has-own-configmap.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/19-service-shared-among-namespaces.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/22-ingress-controller.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/23-ingress-controller-cloud-provider.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/24-ingress-controller-bare-metal-proxy.PNG" width="48%" height="30%">
...
- 3=create Ingress "rule" resource for k8s dashboard, i.e. [dashboard Ingress](https://github.com/paguerre3/kubeops/blob/master/dashboard-ingress.yml) and execute <pre><code>kubectl apply -f .\dashboard-ingress.yml
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/25-hosts-as-proxy.PNG" width="43%" height="40%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/26-ingress-same-host-multiple-paths.PNG" width="48%" height="30%">

-B. multiple sub-domains or domains, i.e. each host represents a subdomain
<img src="https://github.com/paguerre3/kubeops/blob/master/support/27-multiple-domains.PNG" width="48%" height="30%">

-B. configuring TLS certificate, i.e. configuring HTTPS protocol forwarding in Ingress, e.g. 
<img src="https://github.com/paguerre3/kubeops/blob/master/support/28-ingress-tls-certificate.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/29-helm-template.PNG" width="73%" height="70%">   

<img src="https://github.com/paguerre3/kubeops/blob/master/support/30-helm-template-values.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/31-helm-chart-structure.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/32-helm-values-override.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/33-persistent-volume.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/34-multiple-storages.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/35-nfs-storage.PNG" width="73%" height="70%">

- <code>spec</code> attributes differ depending on storage "type", e.g.
<img src="https://github.com/paguerre3/kubeops/blob/master/support/36-gc-storage.PNG" width="73%" height="70%">

<img src="https://github.com/paguerre3/kubeops/blob/master/support/37-local-storage.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/38-persistent-volume-claim.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/39-persistent-volume-claim-pod-reference.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/40-volumes-abstraction-levels.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/41-persistent-volume-mounts.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/42-mount-configmap-secret.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/43-pod-with-multiple-volumes.png" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/44-storage-class-and-pvc.PNG" width="83%" height="80%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/45-storage-class-usage.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/46-statefulset-identity.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/47-statefulset-cluster-sync.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/48-statefulset-pv-reattach.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/49-statefulset-2-endpoints.PNG" width="73%" height="70%">
...
**NOTE**
> as mentioned in previous sections, Service communication with the Pod is done through the use of selectors and target ports. Service is usually defined inside Deployment, e.g. [mongo Deployment + InternalService](https://github.com/paguerre3/kubeops/blob/master/mongo.yml). Service <code>port</code> is arbitrary while <code>targetPort</code> must match the port the Container is listening at. Also, notice that when Services are created k8s generates an Endpoint object with the same name as the Service that is responsible for keeping track of which Pods are the member/endpoints of the Service

<img src="https://github.com/paguerre3/kubeops/blob/master/support/50-endpoints.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/51-clusterip-multiple-ports.PNG" width="73%" height="70%">

<img src="https://github.com/paguerre3/kubeops/blob/master/support/52-clusterip-multiple-ports.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/53-headless-svc-dns-lookup.PNG" width="73%" height="70%">

- No ClusterIP is assigned in case of Headless Service, e.g.
<img src="https://github.com/paguerre3/kubeops/blob/master/support/54-headless-svc-no-clusterip.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/55-headless-svc-and-clusterip.PNG" width="48%" height="30%">

- there are 3 service type attributes, i.e. Service=<code>spec</code>:<code>type: ClusterIP, NodePort or LoadBalancer</code>
<img src="https://github.com/paguerre3/kubeops/blob/master/support/56-service-types.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/57-node-port.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/58-node-port-ip.PNG" width="73%" height="70%">

<img src="https://github.com/paguerre3/kubeops/blob/master/support/59-node-port-ip-clusterip.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/60-node-port-across-replica-pods.PNG" width="48%" height="30%">

**NOTE**
> NodePort is insecure as it opens an stable port to be accessed externally
<img src="https://github.com/paguerre3/kubeops/blob/master/support/61-node-port-insecure.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/62-load-balancer.PNG" width="48%" height="30%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/63-load-balancer-spec.png" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/64-svc-types-details.PNG" width="73%" height="70%">
...
<img src="https://github.com/paguerre3/kubeops/blob/master/support/65-ingress-or-load-balancer.PNG" width="48%" height="30%">
